            ...
            <main className="download-main">
                <div className="download-content animate-fade-in">
                    ...
                    <p className="download-subtitle animate-slide-up delay-100">
                        From glance to hello, made easy
                    </p>
                    <p className="download-description animate-slide-up delay-200">
                    ...
                    {/* Features */}
                    <div className="download-features animate-fade-in delay-400">
                        <div className="download-feature">
                            <div className="download-feature-icon">📍</div>
                            <span>Proximity Discovery</span>
                        </div>
                        <div className="download-feature">
                            <div className="download-feature-icon">🔒</div>
                ...
                {/* Phone Mockup */}
                <div className="download-mockup animate-slide-right delay-200">
                    <div className="download-phone-frame">
                        <Image
                            src="/image/1.webp"
                            alt="Hamsey App Screenshot"
                            width={280}
                            height={560}
