...
const STORE_LINKS = {
  ...
  appStore: "https://apps.apple.com/in/app/hamsey-from-glance-to-hello/id6755126171",
};
      ...
      <div className="hero-content">
        ...
        <div className="hero-app-buttons animate-slide-up delay-300">
          <a
            ...
            aria-label="Download Hamsey on Google Play Store"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="app-store-btn"
            aria-label="Download Hamsey on Apple App Store"
          >
            {/* Apple Icon */}
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
